...
class Move_only_function_mock_base : public ::testing::MockFunction<Return_type(Args...)>
{
  public:
    ...
    {
        return as_function_impl<Function>();
    }
};
...
class Move_only_function_mock<Return_type(Args...)>
    : public internal::Move_only_function_mock_base<std::function<Return_type(Args...)>, Return_type, Args...>
{
};
...
class Move_only_function_mock<::score::cpp::move_only_function<Return_type(Args...), Storage_size, Alignment>>
