...
class ProxyEventBaseFixture : public ::testing::Test
{
  public:
    ...
    void CreateServiceElement()
    {
        ...
        service_element_ =
            std::make_unique<ServiceElementType>(kEventName, std::move(mock_service_element_binding_ptr));
...
TYPED_TEST(ProxyEventBaseUnsubscribeFixture, CallingUnsubscribeWhileSubscribedCallsUnsubscribeOnBinding)
{
    ...
    // When Subscribe and then Unsubscribe is called on the ProxyElement
...
TYPED_TEST(ProxyEventBaseUnsubscribeFixture, CallingUnsubscribeWhileSubscriptionIsPendingCallsUnsubscribeOnBinding)
{
    ...
    // and given that GetSubscriptionState returns kNotSubscribed then kSubscriptionPending
    EXPECT_CALL(*this->mock_service_element_binding_, GetSubscriptionState())
        .WillOnce(Return(SubscriptionState::kNotSubscribed))
...
TYPED_TEST(ProxyEventBaseUnsubscribeFixture, CallingUnsubscribeTwiceAfterSubscribeOnlyDispatchesToBindingOnce)
{
    ...
    // Expecting that Unsubscribe will be called on the binding exactly once across both Unsubscribe calls
    ...
    // Then Unsubscribe is dispatched to the binding only once
}
...
TYPED_TEST(ProxyEventBaseUnsubscribeDeathTest, CallingUnsubscribeWhileASampleIsStillReferencedTerminates)
{
    const auto CallUnsubscribeWhileSampleIsStillAllocated = [this]() {
        ...
        // Expecting that Unsubscribe will be called on the binding
        EXPECT_CALL(*this->mock_service_element_binding_, Unsubscribe());
...
TYPED_TEST(AServiceElement, WhenSettingAReceiveHandlerThenItWillDispatchToTheBinding)
{
    this->RecordProperty("lobster-tracing",
                         ...
                         "Communication.GenericProxyEventSetReceiveHandler");
...
TYPED_TEST(ProxyEventBaseSubscribeFixture, CallingSubscribeWhileUnsubscribedDispatchesToBinding)
{
    this->RecordProperty("lobster-tracing",
                         ...
                         "Communication.GenericProxyEventSubscribe");
...
TYPED_TEST(ProxyEventBaseGetSubscriptionStatefixture, GetSubscriptionStateDispatchesToBinding)
{
    this->RecordProperty("lobster-tracing",
                         ...
                         "Communication.GenericProxyEventGetSubscriptionState");
    this->RecordProperty("Description",
...
{
    this->RecordProperty("Verifies", "SCR-21293991");
    this->RecordProperty("lobster-tracing",
                         "Communication.ProxyFieldGetFreeSampleCount, Communication.ProxyEventGetFreeSampleCount, "
                         "Communication.GenericProxyEventGetFreeSampleCount");
    this->RecordProperty(
        "Description",
...
TYPED_TEST(ProxyEventBaseGetNumNewSamplesAvailableFixture, GetNumNewSamplesAvailableDispatchesToBinding)
{
    this->RecordProperty(
        ...
        "Communication.GenericProxyEventGetNumNewSamplesAvailable");
    this->RecordProperty(
        "Description",
