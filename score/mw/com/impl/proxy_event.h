...
class ProxyEvent final : public ProxyEventBase
{
    ...
    // coverity[autosar_cpp14_a11_3_1_violation]
    friend class ProxyField<SampleDataType, true, true>;
    friend class ProxyField<SampleDataType, true, false>;
    friend class ProxyField<SampleDataType, false, true>;
    friend class ProxyField<SampleDataType, false, false>;
