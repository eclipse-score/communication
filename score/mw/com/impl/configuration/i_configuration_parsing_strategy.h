 ...
 ********************************************************************************/
#ifndef SCORE_MW_COM_IMPL_CONFIGURATION_I_CONFIGURATION_PARSING_STRATEGY_H
#define SCORE_MW_COM_IMPL_CONFIGURATION_I_CONFIGURATION_PARSING_STRATEGY_H
...
class IConfigurationParsingStrategy
{
  ...
  protected:
    ...
    IConfigurationParsingStrategy(IConfigurationParsingStrategy&&) noexcept = default;
...
#endif  // SCORE_MW_COM_IMPL_CONFIGURATION_I_CONFIGURATION_PARSING_STRATEGY_H
