...
/// events. It will be used by a concrete impl::SkeletonEvent to perform any binding specific operation.
/// \details The APIs this interface provides, deal with void-pointers (SamplePtr/SampleAllocateePtr), since the binding
/// layer is type-erased! The type knowledge for the events is held on the binding independent impl::SkeletonEvent,
/// which does the transformation/rebind from type-erased (void) to typed (non-void) representation.
