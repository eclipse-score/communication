...
TEST(UniqueMethodIdentifierTest, EqualObjectsAreEqual)
{
...
TEST(UniqueMethodIdentifierTest, ObjectsWithDifferentIdAreNotEqual)
{
...
TEST(UniqueMethodIdentifierTest, ObjectsWithDifferentMethodTypeAreNotEqual)
{
...
TEST(UniqueMethodIdentifierTest, EqualObjectsReturnTheSameHash)
{
    // Given two UniqueMethodIdentifier objects containing the same values
...
TEST(UniqueMethodIdentifierTest, ObjectsWithDifferentMethodTypeReturnDifferentHash)
{
    // Given two UniqueMethodIdentifier objects with the same id but different MethodType
...
TEST(UniqueMethodIdentifierTest, ObjectsWithDifferentIdReturnDifferentHash)
{
...
TEST(UniqueMethodIdentifierTest, MethodAndGetWithSameIdReturnDifferentHash)
{
...
TEST(UniqueMethodIdentifierTest, EqualObjectsWithMaxValuesReturnTheSameHash)
{
...
TEST(UniqueMethodIdentifierTest, MaxIdWithDifferentMethodTypeReturnsDifferentHash)
{
...
TEST(UniqueMethodIdentifierTest, GetAndUnknownWithSameIdReturnDifferentHash)
{
