...
ResultBlank TransactionLogLocalView::RollbackProxyElementLog(const DereferenceSlotCallback& dereference_slot_callback,
...
ResultBlank TransactionLogLocalView::RollbackSkeletonTracingElementLog(
...
// leds to calling std::terminate().
// coverity[autosar_cpp14_a15_5_3_violation : FALSE]
ResultBlank TransactionLogLocalView::RollbackIncrementTransactions(
    const DereferenceSlotCallback& dereference_slot_callback) noexcept
{
...
ResultBlank TransactionLogLocalView::RollbackSubscribeTransactions(
    const UnsubscribeCallback& unsubscribe_callback) noexcept
{
