...
class SampleAllocateePtr
{
  ...
  private:
    ...
    void internal_delete()
    {
        ...
        {
            // LCOV_EXCL_BR_LINE: Defensive programming: The only time that event_data_control_ does not have a value is
            // if the SampleAllocateePtr is default initialised or initialised with a nullptr. In both these, cases
