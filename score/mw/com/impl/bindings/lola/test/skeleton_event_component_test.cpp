...
class SkeletonEventAttorney
{
  public:
    ...
    {
        skeleton_event_.common_event_logic_.SetQmNotificationsRegistered(qm_available);        
        skeleton_event_.common_event_logic_.SetAsilBNotificationsRegistered(asil_b_available);
    }
