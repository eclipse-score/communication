...
TEST_F(MethodSubscriptionRegistrationGuardFixture, MethodSubscriptionRegistrationGuardUsesMovableScopedOperation)
{
    // Expecting that MethodSubscriptionRegistrationGuard is a type alias for utils::MovableScopedOperation. If this is
    ...
    // for MovableScopedOperation.
    static_assert(std::is_same_v<MethodSubscriptionRegistrationGuard,
