...
class TransactionLogRegistrationGuard
{
  public:
    ...
    /// \return
    static score::Result<TransactionLogRegistrationGuard> Create(ProxyEventDataControlLocalView<>& event_data_control_local,
    ...
    /// \return
    static TransactionLogRegistrationGuard Create(SkeletonEventDataControlLocalView<>& event_data_control_local) noexcept;
