...
class TransactionLogRegistrationGuard
{
  ...
  private:
    ...
    utils::MovableScopedOperation<score::cpp::callback<void()>> unregister_on_destruction_operation_;
    static_assert(std::is_same_v<decltype(unregister_on_destruction_operation_),
                                 utils::MovableScopedOperation<score::cpp::callback<void()>>>,
