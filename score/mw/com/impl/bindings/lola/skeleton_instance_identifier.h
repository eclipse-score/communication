 ...
 ********************************************************************************/
#ifndef SCORE_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_INSTANCE_IDENTIFIER_H
#define SCORE_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_INSTANCE_IDENTIFIER_H
...
class hash<score::mw::com::impl::lola::SkeletonInstanceIdentifier>
{
  public:
        ...
        const score::mw::com::impl::lola::SkeletonInstanceIdentifier& skeleton_instance_identifier) const noexcept
    {
        ...
        static_assert((sizeof(SkeletonInstanceIdentifier::service_id) +
                       sizeof(SkeletonInstanceIdentifier::instance_id)) < sizeof(std::uint64_t));
...
#endif  // SCORE_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_INSTANCE_IDENTIFIER_H
