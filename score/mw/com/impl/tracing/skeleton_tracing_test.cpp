  ...
  public:
    ...
    SkeletonTracingFixture()
        : empty_skeleton_{std::make_unique<mock_binding::Skeleton>(), kInstanceIdentifier},
          ...
          events_map_{{kEventName, skeleton_event_base_ref_.Get()}},
          fields_map_{{kFieldName, skeleton_field_base_ref_.Get()}}
    {
    ...
    ReferenceToMoveable<SkeletonEventBase> skeleton_event_base_ref_{skeleton_event_base_};
    MyDummyField skeleton_field_base_;
    ReferenceToMoveable<SkeletonFieldBase> skeleton_field_base_ref_{skeleton_field_base_};
