...
const LolaServiceInstanceDeployment kLolaServiceInstanceDeploymentWithEventAndField{
    ...
    {{kDummyFieldName, LolaFieldInstanceDeployment{LolaEventInstanceDeployment{10U, 10U, 2U, true, 0}, false, false}}}
...
class SkeletonEventTracingFixture : public ::testing::TestWithParam<ServiceElementType>
{
  public:
    ...
    impl::SampleAllocateePtr<void> sample_allocatee_data_ptr_{MakeFakeSampleAllocateePtr<void>(&test_sample_buffer_)};
