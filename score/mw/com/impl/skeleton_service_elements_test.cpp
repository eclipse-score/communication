...
// Alias fixture for tests covering multiple-element registration.
// Using a dedicated alias makes GTest output show a clearly named test suite.
using SkeletonServiceElementsWithMultipleElementsFixture = SkeletonServiceElementsFixture;
...
TEST_F(SkeletonServiceElementsWithMultipleElementsFixture, CanRegisterMultipleEventsAndMethods)
{
...
TEST_F(SkeletonServiceElementsFixture, MoveSkeletonUpdatesServiceElementBackReferences)
{
    RecordProperty("Description",
                   ...
                   "UpdateSkeletonReferences correctly re-pointed their back-references.");
    RecordProperty("TestType", "Unit test");
