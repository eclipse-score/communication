 ...
 ********************************************************************************/
#ifndef SCORE_MW_COM_TEST_PARTIAL_RESTART_METHODS_PROVIDER_RESTART_CONSUMER_H
...
void DoConsumerActions(CheckPointControl& check_point_control,
                       ...
                       int argc,
                       const char** argv,
                       const ConsumerParameters& params) noexcept;

}  // namespace score::mw::com::test

#endif  // SCORE_MW_COM_TEST_PARTIAL_RESTART_METHODS_PROVIDER_RESTART_CONSUMER_H
