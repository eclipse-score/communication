 ...
 ********************************************************************************/
#ifndef SCORE_MW_COM_TEST_PARTIAL_RESTART_METHODS_CONSUMER_HANDLE_NOTIFICATION_DATA_H
#define SCORE_MW_COM_TEST_PARTIAL_RESTART_METHODS_CONSUMER_HANDLE_NOTIFICATION_DATA_H
...
struct HandleNotificationData
{
    ...
    std::unique_ptr<TestMethodServiceProxy::HandleType> handle{nullptr};
};
...
#endif  // SCORE_MW_COM_TEST_PARTIAL_RESTART_METHODS_CONSUMER_HANDLE_NOTIFICATION_DATA_H
