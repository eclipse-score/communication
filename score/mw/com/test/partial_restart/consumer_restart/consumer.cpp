...
namespace bmw::mw::com::test
{
    ...
    namespace
    {
        ...
        const auto kProxyInstanceSpecifier = InstanceSpecifier::Create("partial_restart/small_but_great").value();
        const std::chrono::seconds kMaxHandleNotificationWaitTime{15U};

    } // namespace

    void DoConsumerActions(bmw::mw::com::test::CheckPointControl &check_point_control,
