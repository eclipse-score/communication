...
#ifndef SCORE_MW_COM_TEST_PARTIAL_RESTART_PROVIDER_RESTART_PROVIDER_H
#define SCORE_MW_COM_TEST_PARTIAL_RESTART_PROVIDER_RESTART_PROVIDER_H
...
#endif  // SCORE_MW_COM_TEST_PARTIAL_RESTART_PROVIDER_RESTART_PROVIDER_H
