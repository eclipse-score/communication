...
#ifndef SCORE_MW_COM_TEST_COMMON_TEST_RESOURCES_SHARED_MEMORY_OBJECT_GUARD_H
#define SCORE_MW_COM_TEST_COMMON_TEST_RESOURCES_SHARED_MEMORY_OBJECT_GUARD_H
...
#endif  // SCORE_MW_COM_TEST_COMMON_TEST_RESOURCES_SHARED_MEMORY_OBJECT_GUARD_H
