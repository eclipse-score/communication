...
namespace bmw::mw::com::test
{
    ...
    namespace
    {
        ...
        void HashArray(const std::array<LaneIdType, 16U> &array, std::size_t &seed)
        {
            ...
            AMP_ASSERT_PRD(buffer_size > 0);
            seed = amp::hash_bytes_fnv1a(static_cast<const void *>(array.data()), static_cast<std::size_t>(buffer_size), seed);
        }

        class MmanMock : public os::Mman
        {
        public:
            amp::expected<void *, os::Error> mmap(void *addr,
            ...
            amp::expected_blank<os::Error> munmap(void *addr, const std::size_t length) const noexcept override
            {
            ...
            amp::expected<std::int32_t, os::Error> shm_open(const char *pathname,
            ...
            amp::expected_blank<os::Error> shm_unlink(const char *pathname) const noexcept override
            {
            ...
            amp::expected<std::int32_t, os::Error> posix_typed_mem_open(
                const char *name,
                const os::Fcntl::Open oflag,
            ...
            amp::expected<std::int32_t, os::Error> posix_typed_mem_get_info(
                const std::int32_t fd,
            ...
            std::uint32_t GetShmOpenCallcount() const noexcept { return shm_open_callcount_; }

            const char *GetLastShmOpenPath() const noexcept { return last_shm_open_path_; }
        ...
        {
        public:
            SampleReceiver(const bmw::mw::com::InstanceSpecifier &instance_specifier)
        ...
        private:
            ...
            const bmw::mw::com::InstanceSpecifier &instance_specifier_;
            amp::optional<std::uint32_t> last_received_;
        ...
        bmw::result::Error MakeError(const TestErrorCode code, const std::string_view user_message = "") noexcept
        {
        ...
        {
        public:
            TestDestructor(amp::stop_source &stop_source) : stop_source_{stop_source} {}
            ~TestDestructor() { stop_source_.request_stop(); }
        ...
        bool ElementFqIdMatchesConfigurationValue(
            bmw::mw::com::impl::ProxyEvent<SampleType> &proxy_event,
            const bmw::mw::com::impl::lola::ElementFqId element_fq_id_from_config) noexcept
        {
        ...
        amp::optional<std::reference_wrapper<impl::ProxyEvent<MapApiLanesStamped>>> GetMapApiLanesStampedProxyEvent(
            BigDataProxy &proxy)
        {
            return proxy.map_api_lanes_stamped_;
        }

        amp::optional<std::reference_wrapper<impl::GenericProxyEvent>> GetMapApiLanesStampedProxyEvent(
        ...
        bmw::Result<impl::HandleType> GetHandleFromSpecifier(const InstanceSpecifier &instance_specifier,
    ...
    int EventSenderReceiver::RunAsProxy(const bmw::mw::com::InstanceSpecifier &instance_specifier,
                                        ...
                                        bool try_writing_to_data_segment)
    {
        ...
        amp::optional<char> last_received{};
    ...
    int EventSenderReceiver::RunAsSkeleton(const bmw::mw::com::InstanceSpecifier &instance_specifier,
    ...
    int EventSenderReceiver::RunAsSkeletonWaitForProxy(const bmw::mw::com::InstanceSpecifier &instance_specifier,
    ...
    int EventSenderReceiver::RunAsSkeletonCheckEventSlots(const bmw::mw::com::InstanceSpecifier &instance_specifier,
                                                          ...
                                                          amp::stop_source stop_source)
    {
        ...
        const amp::stop_token stop_token = stop_source.get_token();
    ...
    {
        TestDestructor test_destructor(stop_source);
        amp::stop_token stop_token = stop_source.get_token();
    ...
    int EventSenderReceiver::RunAsProxyReceiveHandlerOnly(const bmw::mw::com::InstanceSpecifier &instance_specifier,
                                                          const amp::stop_token &stop_token)
    {
        constexpr const std::size_t SAMPLES_PER_CYCLE = 2U;
        ...
        amp::ignore = skeleton_finished_publishing_.waitWithAbort(stop_token);
    ...
    int EventSenderReceiver::RunAsProxyCheckEventSlots(const bmw::mw::com::InstanceSpecifier &instance_specifier,
    ...
    int EventSenderReceiver::RunAsProxyCheckSubscribeHandler(const bmw::mw::com::InstanceSpecifier &instance_specifier,
                                                             bmw::os::InterprocessNotification &interprocess_notification,
                                                             amp::stop_token stop_token)
    {
        constexpr const std::size_t SAMPLES_PER_CYCLE = 2U;
    ...
    template int EventSenderReceiver::RunAsProxy<BigDataProxy, impl::ProxyEvent<MapApiLanesStamped>>(
        const bmw::mw::com::InstanceSpecifier &,
        const amp::optional<std::chrono::milliseconds>,
        const std::size_t,
