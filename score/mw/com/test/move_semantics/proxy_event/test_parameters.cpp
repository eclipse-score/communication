...
std::size_t GetNumberOfSendIterations(const ProxyMoveScenario scenario)
{
    ...
    else if (scenario == ProxyMoveScenario::kMoveConstructWhileSubscribed)
    {
        // In this scenario, the consumer will:
        //   - find service and create proxy
    ...
    else if (scenario == ProxyMoveScenario::kMoveAssignBeforeSubscribe)
    {
        // In this scenario, the consumer will:
        //   - find service and create proxy
    ...
    else if (scenario == ProxyMoveScenario::kMoveAssignWhileSubscribed)
    {
        // In this scenario, the consumer will:
        //   - create two proxies
