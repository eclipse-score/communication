...
int main(int argc, const char** argv)
{
    ...
    auto process_sync_guard = score::mw::com::test::ProcessSynchronizer::CreateUniquePtr(
        score::mw::com::test::kInterprocessNotificationShmPath);
    process_sync_guard->Reset();
    auto withdraw_sync_guard = score::mw::com::test::ProcessSynchronizer::CreateUniquePtr(
        score::mw::com::test::kProviderWithdrawNotificationShmPath);
