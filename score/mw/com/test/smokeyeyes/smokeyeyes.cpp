...
// uid 1300 - 1311 is reserved for use. See /display/User+Management
            ...
            namespace test
            {
                ...
                namespace
                {
                    ...
                    public:
                        ...
                        std::uint32_t GetSequenceCounter() const noexcept { return sequence_counter_; }
                    ...
                    private:
                        void UpdateHash() noexcept { hash_ = GenerateHash(); }
                    ...
                    struct SharedState
                    {
                        ...
                        ~SharedState() { pthread_barrier_destroy(&barrier_); }
                    ...
                    {
                        auto instance_specifier_result = bmw::mw::com::InstanceSpecifier::Create("smokeyeyes/small_but_great");
                                     ...
                                     std::ostream &out)
                    {
                        ...
                        for (std::size_t retry = 0U; retry < FIND_SERVICE_MAX_NUM_RETRIES; ++retry)
                        {
                            ...
                            // service. Can be changed once  is implemented.
