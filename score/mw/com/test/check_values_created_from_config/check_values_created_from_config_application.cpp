...
int main(int argc, const char** argv)
{
    ...
    if (mode == "send" || mode == "skeleton")
    {
        ...
        const score::mw::com::test::SharedMemoryObjectGuard<score::os::InterprocessNotification>
            interprocess_notification_proxy_to_skeleton_guard{interprocess_notification_proxy_to_skeleton_result.value()};
        ...
        const score::mw::com::test::SharedMemoryObjectGuard<score::os::InterprocessNotification>
            interprocess_notification_skeleton_to_proxy_guard{interprocess_notification_skeleton_to_proxy_result.value()};
