...
#ifndef SCORE_MW_COM_TEST_FIELDS_SET_AND_NOTIFIER_GETTER_ONLY_FIELD_H
#define SCORE_MW_COM_TEST_FIELDS_SET_AND_NOTIFIER_GETTER_ONLY_FIELD_H
...
#endif  // SCORE_MW_COM_TEST_FIELDS_SET_AND_NOTIFIER_GETTER_ONLY_FIELD_H
