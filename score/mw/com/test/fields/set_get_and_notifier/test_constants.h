...
#ifndef SCORE_MW_COM_TEST_FIELDS_SET_GET_AND_NOTIFIER_TEST_CONSTANTS_H
#define SCORE_MW_COM_TEST_FIELDS_SET_GET_AND_NOTIFIER_TEST_CONSTANTS_H
...
constexpr const char* const kInstanceSpecifierString = "test/fields/set_get_and_notifier";
...
/// Expected accepted value and field value after Set(kInvalidSetValue): clamped maximum.
...
#endif  // SCORE_MW_COM_TEST_FIELDS_SET_GET_AND_NOTIFIER_TEST_CONSTANTS_H
