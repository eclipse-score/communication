...
namespace
{
constexpr auto kSkeletonInstanceSpecifierString{"test/service_discovery_during_provider_crash"};
}  // namespace
                       ...
                       const char** argv) noexcept
{
    ...
    std::cout << "Provider Step (P.1): skeleton was created. Waiting for proceed instruction to  offer service."
              << std::endl;
