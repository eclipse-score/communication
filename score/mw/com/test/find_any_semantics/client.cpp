            ...
            namespace test
            {
                ...
                namespace
                {
                    ...
                    int run_client(const std::size_t num_retries, const std::chrono::milliseconds retry_backoff_time)
                    {
                        ...
                        auto instance_specifier_result = InstanceSpecifier::Create(kInstanceSpecifierStringClient);
                        ...
                        mw::com::ServiceHandleContainer<bmw::mw::com::impl::HandleType> lola_proxy_handles;
                        ...
                        for (std::size_t i = 0; i < lola_proxy_handles.size(); i++)
                        {
                            ...
                            lola_proxy.test_field.GetNewSamples(
                                ...
                                { received_value = *sample_ptr; }, kMaxNumSamples);
