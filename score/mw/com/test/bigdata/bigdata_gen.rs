 ...
 ********************************************************************************/
//! This is the "generated" part for the `BigData` interface. Its main purpose is to provide the
//! imports of the type- and name-dependent part of the FFI and create the respective user-facing
//! objects.
...
mw_com::import_type!(mw_com_test_MapApiLanesStamped, crate::MapApiLanesStamped);
mw_com::import_type!(mw_com_test_DummyDataStamped, crate::DummyDataStamped);

mw_com::import_interface!(mw_com_test_BigData, BigData, {
    map_api_lanes_stamped_: Event<crate::MapApiLanesStamped>,
    dummy_data_stamped_: Event<crate::DummyDataStamped>
});
