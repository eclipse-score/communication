...
int main(int argc, const char** argv)
{
    ...
    auto provider_future = std::async(std::launch::async, score::mw::com::test::RunProvider, stop_source.get_token());
    auto consumer_future = std::async(std::launch::async, score::mw::com::test::RunConsumer, stop_source.get_token());
