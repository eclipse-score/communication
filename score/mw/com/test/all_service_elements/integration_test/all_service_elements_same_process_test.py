...
def test_basic_acceptance_same_process_test(target):
    ...
    instance with events, fields and methods. The second thread creates a Proxy
    subscribing to the Skeleton, interacting with all events, fields and methods, verifying both
