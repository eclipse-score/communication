...
def provider_and_consumer(target, num_consumers, num_proxies_per_consumer, NUM_CALLS_PER_METHOD, config_name, **kwargs):
    ...
    return target.wrap_exec("bin/main_combined_consumer_provider", args, cwd="/opt/MainCombinedConsumerProviderApp", wait_on_exit=True, wait_timeout=120, **kwargs)
