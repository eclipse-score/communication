 ...
 ********************************************************************************/
#ifndef SCORE_MW_COM_TEST_METHODS_METHODS_TEST_RESOURCES_ALL_SIGNATURES_DATATYPE_ALL_SIGNATURES_DATATYPE_H
#define SCORE_MW_COM_TEST_METHODS_METHODS_TEST_RESOURCES_ALL_SIGNATURES_DATATYPE_ALL_SIGNATURES_DATATYPE_H
...
template <typename T>
class AllSignaturesInterface : public T::Base
{
  public:
    using T::Base::Base;
...
using AllSignaturesProxy = score::mw::com::AsProxy<AllSignaturesInterface>;

/// \brief Skeleton side of the test service
using AllSignaturesSkeleton = score::mw::com::AsSkeleton<AllSignaturesInterface>;

}  // namespace score::mw::com::test

#endif  // SCORE_MW_COM_TEST_METHODS_METHODS_TEST_RESOURCES_ALL_SIGNATURES_DATATYPE_ALL_SIGNATURES_DATATYPE_H
