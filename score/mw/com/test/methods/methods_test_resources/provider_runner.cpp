                  ...
                  std::size_t num_consumer)
{
    ...
    FailTestIf(!skeleton_result.has_value(), "Provider: Failed to create and offer skeleton.");
    ...
    for (std::size_t i{0}; i < num_consumer; ++i)
    {
        ...
        FailTestIf(!process_synchronizers.at(i), "Provider: Could not create ProcessSynchronizer ", i);
    }
