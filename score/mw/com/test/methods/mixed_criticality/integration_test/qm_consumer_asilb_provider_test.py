...
"""
Test all four method types (InArg and Return, InArg only, Return only, and no InArg or Return) with QM criticality for the consumer and ASIL B criticality for the provider.
...
def test_mixed_criticality_consumer_provider(target):
    call_consumer_and_provider(
        target, Criticality.QM, Criticality.QM, Criticality.ASILB)
