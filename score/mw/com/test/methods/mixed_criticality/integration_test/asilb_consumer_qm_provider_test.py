...
"""
Test all four method types (InArg and Return, InArg only, Return only, and no InArg or Return) with ASIL B criticality for the consumer and QM criticality for the provider.
...
def test_mixed_criticality_consumer_provider(target):
    print("Starting asilb consumer and qm provider...")
    call_consumer_and_provider(
        target, Criticality.ASILB, Criticality.QM, Criticality.QM, timeout_sec=120)
