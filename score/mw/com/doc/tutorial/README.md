...
really interested in a deeper understanding, please look into the [design documentation](../../design/README.md).
...
`score::mw::com`
> always/only uses the `LoLa` binding and a specific central `score::mw::com` application &ndash; the gateway app &ndash;
...
dedicated `README.md` with the chapter text. Follow them in order &ndash; later chapters build on earlier ones.

- [Chapter 1: Hello World](chapter_1/README.md)
- [Chapter 2: Hello World configuration refined](chapter_2/README.md)
- [Chapter 3: Finding (multiple) service instances asynchronously](chapter_3/README.md)
- [Chapter 4: Subscription state](chapter_4/README.md)
- [Chapter 5: Sample reception - polling vs. callback](chapter_5/README.md)
- [Chapter 6: Strategies for Sizing sample slots](chapter_6/README.md)
- [Chapter 7: Fields - events on steroids](chapter_7/README.md)
- [Chapter 8: Methods - request/response communication](chapter_8/README.md)
- [Chapter 9: Fields - Get() and Set()](chapter_9/README.md)
- [Chapter 10: Access control for service instances](chapter_10/README.md)
- [Chapter 11: Direct use of an InstanceIdentifier](chapter_11/README.md)
