...
we now load a specific configuration! So, if you look at line 37 of [consumer.cpp](consumer/consumer.cpp) file,
...
Typically &ndash; as you have seen in our HelloWorld example in chapter 1 &ndash; there is **no need** for an explicit
...
This is, how the provider app configuration looks like in [mw_com_config.json](provider/mw_com_config.json)
...
If you now look at the consumer app configuration in [consumer_config.json](consumer/consumer_config.json)
...
configuration.
This is explained in detail in the configuration documentation [here](../../../impl/configuration/README.md#role-dependent-view).
