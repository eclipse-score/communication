...
![Structural View](./event_lola_model.png)
...
![Activity Allocate Sample Slot](./lola_event_allocate_activity.png)
...
![Activity Allocate Mixed Criticality](./lola_event_allocate_mixed_critical_activity.png)
...
![Coherent Status Update](./lola_coherent_set_writing_activity.png)
...
![Activity GetNewSamples](./get_new_samples_activity.png)

The activity shown above thereby relies on activity `ReferenceNextEvent`, which is shown here:

![Activity GetNewSamples](./lola_reference_next_event_activity.png)
...
![Structural View_MessagePassing](./lola_message_passing_model.png)
...
![Sequence Message Passing Init](./lola_msg_pass_initialize_seq.png)
...
![Proxy Event Subscription State Machine](./proxy_event_state_machine.png)

The structural model of the state machine design is as follows:

![Structural View Proxy Event Subscription State Machine](./proxy_event_state_machine_model.png)
...
![Sequence Message Passing Event Notify](./lola_msg_pass_event_notify.png)
...
![Sequence Update Event and Access via Polling](./event_poll_lola_seq.png)
...
![Sequence during sample reception on proxy side](./sampleptr_ref_counting.png)
