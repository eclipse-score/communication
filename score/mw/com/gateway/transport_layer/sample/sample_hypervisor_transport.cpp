...
SampleHyperVisorTransport::SampleHyperVisorTransport(GatewayCore& gateway_app,
    ...
    : gateway_app_{gateway_app}, transport_{std::move(transport)}
{
}
...
{
    transport_->SetMessageHandler([this](std::unique_ptr<TransportMessage> message) {
                                                           ...
                                                           std::string updated_element_name)
{
    ...
    return transport_->SendNotification(notification);
}
