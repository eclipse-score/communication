...
inline constexpr MessageType ToMessageType(RequestType type)
{
    return static_cast<MessageType>(type);
}

inline constexpr MessageType ToMessageType(NotificationType type)
{
    return static_cast<MessageType>(type);
}

inline constexpr MessageType ToMessageType(ResponseType type)
{
    return static_cast<MessageType>(type);
}
