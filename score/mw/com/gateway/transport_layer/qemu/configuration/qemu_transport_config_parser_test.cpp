...
TEST(QemuTransportConfigParserTest, TerminatesWhenPreferredBarNumIsNotInteger)
{
    ...
    // Then parsing terminates instead of selecting an unintended BAR.
    EXPECT_DEATH(ParseQemuTransportConfig(std::move(json)), ".*");
}
