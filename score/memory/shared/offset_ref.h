...
/// - can only be constructed from a valid reference to T (never from a raw pointer and never "null").
/// - is neither copyable nor moveable (just like a native C++ reference cannot be re-bound after construction).
///
