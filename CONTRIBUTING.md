...
the expectations stated below. This is implemented via bazelisk's
[`tools/bazel`](https://github.com/bazelbuild/bazelisk?tab=readme-ov-file#toolsbazel) hook, see
